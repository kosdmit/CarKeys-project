"""
Django settings for carkeys_project project.
...
ALLOWED_HOSTS = ['185.14.45.230:8001',
                 '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'carkeys_project.urls'
...
WSGI_APPLICATION = 'carkeys_project.wsgi.application'
